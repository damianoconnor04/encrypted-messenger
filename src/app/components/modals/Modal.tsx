      ...
      {isOpen && (
        <div className='fixed z-50 inset-0'>
          <main className='flex items-center justify-center min-h-screen p-12 md:p-0'>
            <div className='t-bg-overlay absolute inset-0' onClick={handleClose} />
            <div className={`absolute inset-0 md:relative z-[9999] t-bg md:rounded-2xl p-2 ${maxW === "2xl" && `md:max-w-2xl`} ${maxW === "md" && `md:max-w-md`} w-full t-text`}>
